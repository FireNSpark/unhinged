// server.js — Unhinged (Render-ready, matching capitalized model file names)
...
// ROUTES import authRoutes from './routes/auth.js'; import profileRoutes from './routes/profile.js'; import matchRoutes from './routes/matches.js'; import confessionRoutes from './routes/confessions.js'; import badgeRoutes from './routes/badges.js'; import messageRoutes from './routes/messages.js';
...
// health check app.get('/health', (_req, res) => res.json({ ok: true }));
...
// start const PORT = process.env.PORT || 5000; const URI = process.env.MONGO_URI; // must include DB name in URI
